...
int main() {
    try
    {
        ...
        Function f1(one,base_func,11,{300,300},num_points,xscale,yscale);
        Function f2(slope,base_func,11,{300,300},num_points,xscale,yscale);
        Function f3(cos,base_func,11,{300,300},num_points,xscale,yscale);
        f3.set_color(Color::blue);
        Function f4(sloping_cos,base_func,11,{300,300},num_points,xscale,yscale);
